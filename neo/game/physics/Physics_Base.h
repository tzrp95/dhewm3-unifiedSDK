...
public:	// common physics interface
	...
	inline const idEntity  *GetSelf() { return this->self; }	// water physics
...
protected:
	...
	idPhysics_Liquid		*water;					// water physics: the water object the object is in, we use this to check density/viscosity
