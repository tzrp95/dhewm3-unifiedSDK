...
idCVar ai_think(					"ai_think",						"1",					CVAR_BOOL | CVAR_TOOL, "Prevent AI from thinking." );

idCVar actor_noDamage(				"actor_noDamage",				"0",					CVAR_BOOL | CVAR_TOOL, "Prevent actors from taking damage." );

idCVar g_testStuff(					"g_testStuff",					"0",					CVAR_INTEGER, "Does nothing, it's here just for testing various stuff." );
idCVar g_testModelPitch(			"g_testModelPitch",				"0",					CVAR_FLOAT | CVAR_TOOL, "Pitch of angle of test mode." );
